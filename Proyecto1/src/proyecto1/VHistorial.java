    ...
    public void mostrarInformacion(int fijoi, int fijoj) { //son las posiciones en las que esta la persona y la cuenta
        ...
        for (int j = 0; j < infoPersona[fijoi].cuentaAsociada[fijoj].ContadorTransacciones; j++) {
            dtm.addRow(new Object[]{
                infoPersona[fijoi].cuentaAsociada[fijoj].operacion[j].getIdHistorial(), //agrega primera columna, primera fila
                infoPersona[fijoi].cuentaAsociada[fijoj].operacion[j].getFechaHoraActuales(), //agrega segunda columna, primera fila
                infoPersona[fijoi].cuentaAsociada[fijoj].operacion[j].getDescripcion(), //agrega Tercera columna, primera fila
                infoPersona[fijoi].cuentaAsociada[fijoj].operacion[j].getMontoDebitado(), //agrega cuarta columna, primera fila
                infoPersona[fijoi].cuentaAsociada[fijoj].operacion[j].getMontoAcreditado(), //agrega quinta columna, primera fila
                infoPersona[fijoi].cuentaAsociada[fijoj].operacion[j].getSaldoActual() //agrega sexta columna, primera fila
            });
        }
